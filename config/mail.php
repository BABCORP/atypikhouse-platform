...
return [
    ...
    'prefer_brevo_api' => $bool(env_value('MAIL_PREFER_BREVO_API', true), true),
    'smtp_timeout' => max(1, (int) env_value('SMTP_TIMEOUT', env_value('MAIL_TIMEOUT', 3))),
    'api_timeout' => max(1, (int) env_value('BREVO_API_TIMEOUT', 3)),
    'smtp' => [
        'host' => $host,
