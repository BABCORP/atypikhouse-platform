<section class="hero">
    ...
    <form role="search" aria-label="Recherche d’hébergements" class="search-panel hero-search" method="get" action="<?= url('/hebergements') ?>" data-track="search_submit">
...
<section class="section band">
    ...
    <div class="features">
        <article role="article"><h3>1. Recherchez</h3><p>Filtrez par destination, type de logement, capacité et budget.</p></article>
        <article role="article"><h3>2. Réservez votre séjour</h3><p>Choisissez vos dates, vérifiez le prix et validez un paiement fictif de démonstration.</p></article>
        <article role="article"><h3>3. Voyagez autrement</h3><p>Projetez-vous dans des séjours nature, simples et mémorables.</p></article>
    </div>
</section>

<section class="section home-flow">
    <div class="home-flow-main">
        <article role="article" class="home-editorial">
    ...
    <div class="home-flow-secondary">
        ...
        <article role="article" class="home-categories">
