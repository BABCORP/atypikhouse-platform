...
<section class="section narrow">
    <form role="form" class="panel" method="post">
        ...
        <label>Prénom<input required name="first_name" value="<?= e($editUser['first_name']) ?>"></label>
        <label>Nom<input required name="last_name" value="<?= e($editUser['last_name']) ?>"></label>
        <label>Email<input required type="email" name="email" value="<?= e($editUser['email']) ?>"></label>
        <label>Téléphone<input name="phone" value="<?= e($editUser['phone']) ?>"></label>
        <label>Rôle
            <select name="role">
