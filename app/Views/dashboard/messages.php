        ...
        <?php foreach ($messages as $message): ?>
            <article role="article" class="panel">
                ...
                <div class="actions-row">
                    ...
                    <form role="form" class="inline-form" method="post" action="<?= url('/admin/messages/' . $message['id'] . '/lu') ?>"><?= csrf_field() ?><button class="button compact" type="submit">Marquer lu</button></form>
                    <form role="form" class="inline-form" method="post" action="<?= url('/admin/messages/' . $message['id'] . '/traite') ?>"><?= csrf_field() ?><button class="button ghost compact" type="submit">Traité</button></form>
                    <form role="form" class="inline-form" method="post" action="<?= url('/admin/messages/' . $message['id'] . '/archiver') ?>" data-confirm="Archiver ce message ?"><?= csrf_field() ?><button class="button danger compact" type="submit">Archiver</button></form>
                </div>
            </article>
        <?php endforeach; ?>
