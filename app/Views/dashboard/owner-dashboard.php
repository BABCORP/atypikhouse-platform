...
<section class="section">
    ...
    <div class="stats">
        ...
        <article><strong><?= money(array_sum(array_map(fn($b) => $b['payment_status']==='test_paid' ? (float)$b['total_price'] : 0, $bookings))) ?></strong><span>revenu de démonstration</span></article>
    </div>
